...
claim = "I like to eat food"
document = "I like to eat food"
...
tfreq_vectorizer = pickle.load(open(var.PICKLE_SAVE_FOLDER + "bow_vectorizer.pickle", "rb"))
tfidf_vectorizer = pickle.load(open(var.PICKLE_SAVE_FOLDER + "bow_vectorizer.pickle", "rb"))
...
with tf.Session(graph=graph2) as sess:
    ...
    p_logits = graph.get_tensor_by_name("SparseSoftmaxCrossEntropyWithLogits/SparseSoftmaxCrossEntropyWithLogits:0")
